...
exports.NUMBER_OF_IDENTIFIER_CONTINUATION_CHARS = exports.NUMBER_OF_IDENTIFIER_START_CHARS = void 0;
...
exports.NUMBER_OF_IDENTIFIER_START_CHARS = DELTA_A_TO_Z * 2 + 2; // a-z A-Z _ $
exports.NUMBER_OF_IDENTIFIER_CONTINUATION_CHARS = exports.NUMBER_OF_IDENTIFIER_START_CHARS + 10; // a-z A-Z _ $ 0-9
...
class Template {
    ...
    static numberToIdentifier(n) {
        if (n >= exports.NUMBER_OF_IDENTIFIER_START_CHARS) {
            // use multiple letters
            return (Template.numberToIdentifier(n % exports.NUMBER_OF_IDENTIFIER_START_CHARS) +
                Template.numberToIdentifierContinuation(Math.floor(n / exports.NUMBER_OF_IDENTIFIER_START_CHARS)));
        }
        // lower case
        if (n < DELTA_A_TO_Z) {
    ...
    static numberToIdentifierContinuation(n) {
        if (n >= exports.NUMBER_OF_IDENTIFIER_CONTINUATION_CHARS) {
            // use multiple letters
            return (Template.numberToIdentifierContinuation(n % exports.NUMBER_OF_IDENTIFIER_CONTINUATION_CHARS) +
                Template.numberToIdentifierContinuation(Math.floor(n / exports.NUMBER_OF_IDENTIFIER_CONTINUATION_CHARS)));
        }
        // lower case
        if (n < DELTA_A_TO_Z) {
            return String.fromCharCode(START_LOWERCASE_ALPHABET_CODE + n);
        ...
        for (const module of runtimeModules) {
            ...
            if (runtimeSource) {
                ...
                if (!module.shouldIsolate()) {
                    ...
                    source.add("(() => {\n");
                    source.add(new webpack_sources_1.PrefixSource("\t", runtimeSource));
                    source.add("\n})();\n\n");
                }
                else {
                    source.add("!function() {\n");
    ...
    static renderChunkRuntimeModules(runtimeModules, renderContext) {
        return new webpack_sources_1.PrefixSource("/******/ ", new webpack_sources_1.ConcatSource("function(__webpack_require__) { // webpackRuntimeModules\n", this.renderRuntimeModules(runtimeModules, renderContext), "}\n"));
    }
}
