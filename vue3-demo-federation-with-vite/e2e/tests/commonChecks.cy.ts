...
describe('Vue 3 Demo Federation with Vite', function () {
  context('It checks buttons with text visibility and position for both apps', () => {
    ...
    appsData.forEach(function (property: {
      ...
      const secondButtonSelector =
        property.host === 5173 ? appsData[1].selector : appsData[0].selector;
      const secondButtonText = property.host === 5173 ? appsData[1].text : appsData[0].text;
