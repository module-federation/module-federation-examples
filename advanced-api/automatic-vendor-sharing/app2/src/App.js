  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <header style={{ marginBottom: '30px', textAlign: 'center' }}>
        ...
        <h2 style={{ color: '#008', fontWeight: 'normal' }}>App 2 (Host & Remote)</h2>
      ...
      <div style={{ display: 'grid', gap: '20px', gridTemplateColumns: '1fr 1fr' }}>
        <section style={{ padding: '20px', backgroundColor: '#f9f9f9', borderRadius: '8px' }}>
          <h3 style={{ marginTop: 0, color: '#008' }}>Local Component</h3>
          <LocalButton />
        ...
        <section style={{ padding: '20px', backgroundColor: '#f9f9f9', borderRadius: '8px' }}>
          <h3 style={{ marginTop: 0, color: '#800' }}>Remote Component (App 1)</h3>
          <ErrorBoundary>
            <Suspense fallback={<LoadingFallback message="Loading App 1 Button..." />}>
              <RemoteButton />
            </Suspense>
          </ErrorBoundary>
          <p style={{ fontSize: '12px', color: '#666', marginTop: '10px' }}>
            This button is loaded from App 1 via Module Federation
