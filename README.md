...
- [x] [Different React Versions in Isolation](./isolated-react-versions/README.md) &mdash; Simple host/remote example where the apps have different React and ReactDOM versions and don't share any dependencies.
