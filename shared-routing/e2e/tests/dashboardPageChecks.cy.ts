...
const sharedRoutingAppChartBlockSelector = selectors.sharedRoutingApp.commonWidgetSelector.replace(
  '{selector}',
  Constants.selectorParts.sharedRoutingAppSelectorsParts.chart.toUpperCase(),
);
const sharedRoutingAppRecentDepositsBlockSelector =
  selectors.sharedRoutingApp.commonWidgetSelector.replace(
    '{selector}',
    Constants.selectorParts.sharedRoutingAppSelectorsParts.recentDeposits.toUpperCase(),
  );
const sharedRoutingAppRecentOrdersBlockSelector =
  selectors.sharedRoutingApp.commonWidgetSelector.replace(
    '{selector}',
    Constants.selectorParts.sharedRoutingAppSelectorsParts.recentOrders.toUpperCase(),
  );
