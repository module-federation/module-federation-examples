...
const sharedRoutingAppOrdersBlockSelector = selectors.sharedRoutingApp.commonWidgetSelector.replace(
  '{selector}',
  Constants.selectorParts.sharedRoutingAppSelectorsParts.recentOrders.toUpperCase(),
);
const sharedRoutingAppOrdersRowSelector = selectors.sharedRoutingApp.recentOrdersRow.replace(
  Constants.selectorParts.sharedRoutingAppReplaceSelectorPart,
  '',
);
const sharedRoutingAppOrdersRowCellSelector =
  selectors.sharedRoutingApp.recentOrdersWidgetCell.replace(
    Constants.selectorParts.sharedRoutingAppReplaceSelectorPart,
    '',
  );
