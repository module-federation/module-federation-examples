...
const methodsPage: DifferentReactVersionsTypescriptMethods =
  new DifferentReactVersionsTypescriptMethods();
  ...
  context('Check App1', () => {
    ...
    it('Check App headers and buttons visability', () => {
      ...
      basePage.checkElementHaveProperty({
        selector: methodsPage.getBlockSelector(
          baseSelectors.tags.coreElements.button.toUpperCase(),
        ),
