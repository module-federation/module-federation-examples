...
export declare const Adapted: React.ForwardRefExoticComponent<
  ModernReactComponentProps & React.RefAttributes<ReactAdapterProvider<ModernReactComponentProps>>
>;
