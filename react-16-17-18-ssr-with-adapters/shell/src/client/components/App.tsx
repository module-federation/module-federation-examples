...
import { ReactAdapterConsumer } from 'react-version-adapter';
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '1rem' }}>
        ...
        <h2>This is the shell application (React v18.2.0)</h2>
      ...
      <ReactAdapterConsumer<ContentProps>
        fallback={<div>Loading...</div>}
        importer={() => import('remote1/Content').then(module => ({ default: module.Adapted }))}
        content={state}
      />
