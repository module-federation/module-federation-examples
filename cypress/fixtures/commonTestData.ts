...
export class CommonTestData {
  ...
  public static readonly commonMicroFrontendsAppsData = [
    {
      ...
      symbolName:
        Constants.commonConstantsData.commonMicroFrontendsAppsCardsSymbolsNames.starSymbol,
    ...
    },
    {
      ...
      symbolName:
        Constants.commonConstantsData.commonMicroFrontendsAppsCardsSymbolsNames.cloudSymbol,
  ...
  public static readonly commonNextJsAppsData = [
    {
      messageType: Constants.commonConstantsData.nextJsAppsCommonPhrases.messages.welcome
        .split(' ')[0]
        .trim(),
      selector: baseSelectors.tags.headers.h1,
      message: Constants.commonConstantsData.nextJsAppsCommonPhrases.messages.welcome,
      linkText: Constants.commonConstantsData.nextJsAppsCommonPhrases.messages.welcome
        .split('to')[1]
        .trim(),
    },
    {
      messageType: Constants.commonConstantsData.nextJsAppsCommonPhrases.messages.start
        .split('by')[0]
        .trim(),
    ...
    {
      messageType:
        baseSelectors.tags.footer.charAt(0).toUpperCase() + baseSelectors.tags.footer.slice(1),
  ...
  public static readonly nextJsAppsHeaderLinkName =
    Constants.commonConstantsData.nextJsAppsCommonPhrases.messages.welcome.split('to')[1].trim();
}
