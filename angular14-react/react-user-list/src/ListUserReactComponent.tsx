...
export const ListUserReactComponent: FunctionComponent<IListUserProps> = (
  props: IListUserProps,
) => {
  ...
  return (
    <div className="container">
      {props.users.length ? (
        ...
        <h3 className="empty-list-message">----- Create user to see data here -----</h3>
      )}{' '}
    </div>
  );
};
