...
const appsData = returnCommonAngularAppsData(
  Constants.commonConstantsData.commonAngularAppsData.messages.shellWelcome,
);
      ...
      context(`Check ${appName} App Page`, () => {
        ...
        it('Check App is build and running', () => {
          ...
          basePage.checkElementHaveProperty({
            ...
            value:
              Constants.commonConstantsData.commonAngularAppsData.mdmfNavigationItemLogo.gitHubLink,
          });
          basePage.checkElementHaveProperty({
            selector: baseSelectors.tags.coreElements.link,
            attr: Constants.commonConstantsData.commonAttributes.attr,
