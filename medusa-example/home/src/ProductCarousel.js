    ...
    <React.Suspense fallback={<div />}>
      <Carousel slidesToShow={4}>
        <Card
          ...
          style={{ width: "100%" }}
          cover={
            <HeroImage alt="Pugly" src="https://placedog.net/220/280?random" />
          }
        >
        ...
        <Card
          ...
          style={{ width: "100%" }}
          cover={
            <HeroImage alt="Noodle" src="https://placedog.net/221/280?random" />
          }
        >
        ...
        <Card
          ...
          style={{ width: "100%" }}
          cover={
            <HeroImage alt="Dexter" src="https://placedog.net/222/280?random" />
          }
        >
        ...
        <Card
          ...
          cover={
            <HeroImage
              alt="Dinklage"
              src="https://placedog.net/219/280?random"
            />
          }
        >
