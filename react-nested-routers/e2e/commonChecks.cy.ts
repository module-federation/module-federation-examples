  ...
  context('It checks app1/app2', () => {
    const appsData = [
      ...
      },
      {
        ...
        linkMessage: Constants.elementsText.reactNestedRoutersApp.shellAppTextedLinks[4].replace(
          Constants.elementsText.reactNestedRoutersApp.replaceValues[0],
          Constants.elementsText.reactNestedRoutersApp.replaceValues[4],
        ),
      },
    ];
    ...
    appsData.forEach((property: { host: number; message: string; linkMessage: string }) => {
      ...
      it(`Checks texted link visibility`, () => {
        ...
        basePage.checkElementWithTextPresence({
          ...
          text:
            property.host === appsData[1].host
              ? property.linkMessage.replace(
                  Constants.elementsText.reactNestedRoutersApp.replaceValues[4],
                  Constants.elementsText.reactNestedRoutersApp.replaceValues[1],
                )
      ...
      it(`Checks that on click on link url texts on page changed & changes is not reverted after reload`, () => {
        ...
        if (property.host === appsData[0].host) {
          ...
          basePage.checkElementWithTextPresence({
            selector: baseSelectors.tags.coreElements.div,
            text: property.message.replace(
              Constants.elementsText.reactNestedRoutersApp.replaceValues[2],
              Constants.elementsText.reactNestedRoutersApp.replaceValues[3],
            ),
            visibilityState: 'be.visible',
          });
          basePage.checkElementWithTextPresence({
            selector: baseSelectors.tags.coreElements.link,
            text: property.linkMessage.replace(
              Constants.elementsText.reactNestedRoutersApp.replaceValues[0],
              Constants.elementsText.reactNestedRoutersApp.replaceValues[4],
            ),
            visibilityState: 'be.visible',
        ...
        basePage.clickElementWithText({
          selector: baseSelectors.tags.coreElements.link,
          text: appsData[1].linkMessage.replace(
            Constants.elementsText.reactNestedRoutersApp.replaceValues[4],
            Constants.elementsText.reactNestedRoutersApp.replaceValues[1],
          ),
        });
        ...
        basePage.checkElementWithTextPresence({
          selector: baseSelectors.tags.coreElements.div,
          text: property.message.replace(
            Constants.elementsText.reactNestedRoutersApp.replaceValues[5],
            Constants.elementsText.reactNestedRoutersApp.replaceValues[6],
          ),
          visibilityState: 'be.visible',
        });
        basePage.checkElementWithTextPresence({
          ...
          text: property.linkMessage.replace(
            Constants.elementsText.reactNestedRoutersApp.replaceValues[4],
            Constants.elementsText.reactNestedRoutersApp.replaceValues[7],
          ),
          visibilityState: 'be.visible',
        });
        basePage.reloadWindow();
