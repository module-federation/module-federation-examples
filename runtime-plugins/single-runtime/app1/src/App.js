    ...
    >
      ...
      >
        ...
        <p style={{ margin: '0', lineHeight: '1.5' }}>
          This is App1 running on port 3001. Notice in the Runtime Information that App2's module is
          using <code>app1_partial.js</code> instead of <code>remoteEntry.js</code>. This happens
          because App2 lists App1 as a remote, and to avoid loading conflicting runtimes from the
