    ...
    >
      ...
      >
        ...
        <p style={{ margin: '0', lineHeight: '1.5' }}>
          This is App2 running on port 3002. When loading App1's remote components, it uses the
          standard <code>remoteEntry.js</code> because App1 is not the host in this context. Since
          there's no host/remote pattern here, App1 needs its full standalone runtime to operate.
        </p>
      </div>
