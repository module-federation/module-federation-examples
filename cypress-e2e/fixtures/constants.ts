export class Constants {
  ...
  public static readonly commonConstantsData = {
    ...
    commonAngularAppsData: {
      ...
      messages: {
        shellWelcome:
          'Welcome to the Angular 11 Microfrontend demo using Webpack 5 Module Federation',
        shellParagraph:
        ...
        profileParagraph:
          'This profile component is being remotely loaded into the application using Module Federation, angular is shared so the download is minimal for the frontend',
  ...
  public static readonly updatedConstantsData = {
    ...
    reactAppsTranslations: {
      ...
      nextHost: {
        english: {
          title:
            Constants.commonConstantsData.translationInfo.reactAppsTranslations
              .remoteMicroFrontEndIntroduction.english,
          ...
          text: `${
            Constants.commonConstantsData.translationInfo.reactAppsTranslations.mainTextMessage
          } ${Constants.commonConstantsData.translationInfo.reactAppsTranslations.fromNextHostMessage.replace(
            'from',
            'of',
          )}`,
        },
        francais: {
          title:
            Constants.commonConstantsData.translationInfo.reactAppsTranslations
              .remoteMicroFrontEndIntroduction.francais,
          ...
          text: `Ceci est le texte principal ${Constants.commonConstantsData.translationInfo.reactAppsTranslations.fromNextHostMessage.replace(
            'from',
            'de',
          )}`,
        },
    ...
    typeScriptApp: {
      buttons: {
        ...
        large: `${Constants.commonConstantsData.commonCountAppNames.app2.replace(' ', '')} Large ${
  ...
  public static readonly elementsText = {
    reactNestedRoutersApp: {
      shellAppTextedLinks: ['App1 Page1', 'App1 Page2', 'App2 PageA', 'App2 PageB', 'Go to Page 2'],
      shellAppLinks: ['/app-1/page-1', '/app-1/page-2', '/app-2/page-a', '/app-2/page-b'],
      replaceValues: ['2', 'B', 'Page 1', 'Page 2', '1', 'Page A', 'Page B', 'A'],
    },
    vue3DemoFederationWithViteApp: {
      ...
      App1: {
        mainPage: {
          ...
          paragraphs: {
            ...
            third:
              'Feel free to leave me feedback: https://github.com/module-federation/mfe-webpack-demo',
          },
    ...
    angularReactShellApp: {
      ...
      paragraph:
        'This user list component is being remotely loaded into the application from React App using Webpack Module Federation',
    ...
    vueCliApp: {
      sectionsDescriptions: {
        otherSection:
          'This is a component from /other-app.I am being imported.I also has my own behavior like fetching data',
    ...
    angularUniversalSsrApp: {
      ...
      addedCities: ['Prague', 'Saint-Petersburg'],
      angularUniversalSsrAddedValuesNames: ['one', 'two', 'three'],
    },
    vue3CliDemoApp: {
      aboutTab: 'About',
    },
    ...
    rustWasmApp: {
      buttonsNames: ['Play ▶️', 'Tick 🔂', 'Reset ♻️', 'Stop 🛑'],
    },
    viteReactSimpleApp: {
      buttons: {
  ...
  public static readonly commonPhrases = {
    ...
    dynamicRemotesApp: {
      paragraphText:
        'The Dynamic System will take advantage of Module Federation remotes and exposes. It will not load components that have already been loaded.',
      widgetParagraphText: [
    ...
    differentAngularVersionsApps: {
      productParagraph:
        'This product component is being remotely loaded into the application using Module Federation, angular is shared so the download is minimal for the frontend',
    ...
    dynamicSystemHostApp: {
      ...
      paragraphText: ['App2 Moment Dep', 'for format the date'],
    },
    selfHealingApp: {
    ...
    viteSvelteMicroFrontEndsApp: {
      consoleMessages: ["I'm RxJs from host", "I'm RxJs from remote", 'remote got message:'],
    },
    federatedStyles: {
  ...
  public static readonly color = {
    ...
    dynamicRemotesWidgetColor: ['rgb(255, 0, 0)', 'rgb(128, 0, 128)'],
